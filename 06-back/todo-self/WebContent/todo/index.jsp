...
<body>
	<section class="todoapp">
		...
		<section class="main">
			<ul class="todo-list">
				...
				<c:forEach var="todo" items="${todoList}">
					<li>
						<div class="view">
							<label>${todo.content}</label> <a href="${root}/todo?action=delete&no=${todo.no}" class="destroy"></a>
						</div> <input class="edit" value="오늘">
					</li>
				</c:forEach>
		...
		<footer class="footer">
			...
			</span> <a href="${root}/todo?action=clear" class="clear-completed">전체 지우기</a>
		</footer>
	</section>
</body>
</body>
